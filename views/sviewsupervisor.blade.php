		...
		<div class="column col-lg-12 col-md-12 col-xs-12 col-sm-12">
			...
			<div class="box box-primary" style="padding: 15px;">
				<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
					<h3>Name :</h3>
					<h4>{{ $supervisordata -> name }}</h4>
				</div>
				<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
					<h3>Email Id :</h3>
					<h4>{{ $supervisordata -> email }}</h4>
				</div>
				<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
					<h3>Phone :</h3>
					<h4>{{ $supervisordata -> phone }}</h4>
				</div>
				<div style="clear: both;"></div>
				<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
					<h3>Street :</h3>
					<h4>{{ $supervisordata -> street }}</h4>
				</div>
				<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
					<h3>City :</h3>
					<h4>{{ $supervisordata -> city }}</h4>
				</div>
				<div class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
					<h3>State :</h3>
					<h4>{{ $supervisordata -> state }}</h4>
				</div>
				<div style="clear: both;"></div>
			</div>
		</div>

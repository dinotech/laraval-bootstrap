...
@section('main-content')
	<div class="row">
		<div class="column col-lg-12 col-md-12 col-xs-12 col-sm-12">
			...
			<a href="{{ url('suplierlist') }}"><button type="button" class="btn btn-primary" style="float:right;margin:20px 0 10px 10px">Back</button></a>
			<div style="clear:both;"></div>
			<div class="box box-primary" style="padding:30px;">
				<form method="POST" action="{{ url('/newsupervisor') }}">
	                {{ csrf_field() }}
	                	<input type="hidden" name="user_type" value="Suplier" />
